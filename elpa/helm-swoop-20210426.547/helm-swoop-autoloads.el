;;; helm-swoop-autoloads.el --- automatically extracted autoloads (do not edit)   -*- lexical-binding: t -*-
...
(fn &key QUERY SOURCE (MULTILINE current-prefix-arg))" t)
(autoload 'helm-swoop-from-isearch "helm-swoop" "\
Invoke `helm-swoop' from isearch." t)
...
Start helm-swoop without pre input query." t)
