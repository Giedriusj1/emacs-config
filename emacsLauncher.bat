...
bitsadmin /transfer getEmacsConfig  /download /priority normal https://raw.githubusercontent.com/Giedriusj1/emacs-config/master/emacs.org %HOME%/.emacs.d/emacs.org
