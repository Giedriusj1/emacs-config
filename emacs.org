...
(use-package golden-ratio-scroll-screen :defer t
  :custom
  (customize-set-variable 'golden-ratio-scroll-highlight-flag nil))
...
(defvar swift-command-map
  (let ((map (make-keymap)))
    ...
    (define-key map (kbd "u") 'golden-ratio-scroll-screen-down)
    (define-key map (kbd "j") 'golden-ratio-scroll-screen-up)
