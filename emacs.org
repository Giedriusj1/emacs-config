...
(define-key tab-map (kbd "p") 'alt-projectile-command-map)
...
(defvar alt-projectile-command-map
  (let ((map (make-sparse-keymap)))
    (define-key map (kbd "m") 'helm-projectile-grep)
    (define-key map (kbd "h") 'helm-projectile)
    (define-key map (kbd "d") 'projectile-dired)
    map))
 (fset 'alt-projectile-command-map alt-projectile-command-map)
