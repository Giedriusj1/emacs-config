...
(custom-set-faces '(internal-border ((t (:foreground "OrangeRed" :background "OrangeRed")))))
(custom-set-faces '(eyebrowse-mode-line-active ((t (:foreground "OrangeRed" :weight bold :height 1.2)))))
