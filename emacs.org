...
;; Make sure the packages we use litter the root of .emacs.d as little as
;; possible.
;; This will make them put their configs under ./var and ./etc
...
(defun compile-elpa-and-custom-to-native ()
  ...
  (progn
    ...
    (native-compile-async '("~/.emacs.d/custom-packages" "~/.emacs.d/elpa") t t)))
#+END_SRC
