...
[_g_]rep [_m_] ag [_a_]ck [_r_] projectile-ripgrep
...
(use-package flycheck-rust
  ...
  ;; todo: move inside use-package rust
...
(defhydra hydra-frame-helper
  (:color blue)
  "
[_m_]ake frame [_o_]ther frame [_d_]elete frame
^ _j_ <- -> _k_ | _r_ename | _c_reate | _C_lose current
%s(eyebrowse-mode-line-indicator)^^
[_q_] [_SPC_] [_M-SPC_] quit
 ...
 "
  ...
  ("SPC" nil nil)
  ("M-SPC" nil nil)
  ("j" eyebrowse-prev-window-config nil)
  ("k" eyebrowse-next-window-config nil)
