...
;; (global-set-key (kbd "ESC") 'global-swift-mode)

;; (define-prefix-command 'swift-semi-command-map)

;; (define-key swift-semi-command-map (kbd "1") 'zygospore-toggle-delete-other-windows)
;; (define-key swift-semi-command-map (kbd "2") 'split-window-below)
;; (define-key swift-semi-command-map (kbd "3") 'split-window-right)

;;  (define-key swift-semi-command-map (kbd "j")     
;;  (lambda ()
;;  (interactive)
;;      (let ((x (assq 'swift-mode minor-mode-map-alist)))
;;      (setq minor-mode-map-ali (delete x minor-mode-map-alist) )
;;      (helm-mini)
;;      (setq minor-mode-map-alist (cons x minor-mode-map-alist))))

;;      )


;;  (define-key swift-semi-command-map (kbd ";")     
;;  (lambda ()
;;  (interactive)
;;      (let ((x (assq 'swift-mode minor-mode-map-alist)))

;;      (setq minor-mode-map-alist (delete x minor-mode-map-alist) )
;;      (swiper-helm)
;;      (setq minor-mode-map-alist (cons x minor-mode-map-alist)))))
    
;;  (define-key swift-semi-command-map (kbd "m")     
;;  (lambda ()
;;  (interactive)
;;      (let ((x (assq 'swift-mode minor-mode-map-alist)))
...
;;  (define-key swift-semi-command-map (kbd "s")     
;;  (lambda ()
;;  (interactive)
;;      (let ((x (assq 'swift-mode minor-mode-map-alist)))
...
;;  (define-key swift-semi-command-map (kbd "l")     
;;  (lambda ()
;;  (interactive)
;;      (let ((x (assq 'swift-mode minor-mode-map-alist)))
...
;;  (define-key swift-semi-command-map (kbd "C-l")     
;;  (lambda ()
;;  (interactive)
;;      (let ((x (assq 'swift-mode minor-mode-map-alist)))
...
;;     (define-key map (kbd "u") 'backward-char)
...
;;     (define-key map (kbd "f") 'exchange-point-and-mark)
...
;;     (define-key map (kbd "q") 'beginninswift-of-line)
;;     (define-key map (kbd "w") 'back-to-indentation)
;;     (define-key map (kbd "e") 'end-of-line)

;;     (define-key map (kbd "c") 'kill-rinswift-save)
;;     (define-key map (kbd "v") 'yank)
;;     (define-key map (kbd "x") 'kill-region)

;;     (define-key map (kbd "3") 'windmove-right)
;;     (define-key map (kbd "2") 'windmove-up)
;;     (define-key map (kbd ";") 'swift-semi-command-map)
...
;; (setq swift-map (assq 'swift-mode minor-mode-map-alist))

;; ;; (message swift-map);;aaq
      
;; (if (bound-and-true-p swift-mode)
;;     (progn 
;;     (custom-set-faces '(cursor ((t (:background "blue")))))
;;     (custom-set-faces '(mode-line ((t (:background "SlateBlue4")))))
;;     )

;;     (progn
;;     (custom-set-faces '(cursor ((t (:background "DarkOrange1")))))
;;     (custom-set-faces '(mode-line ((t (:background "#444444")))))
;;     )
;; )
;; )
