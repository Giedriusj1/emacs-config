...
(defvar package-list
  '(yasnippet
    ...
    bind-key
    projectile
    auto-complete-c-headers-20150911
    auto-complete
...
./configure --without-toolkit-scroll-bars --without-sound --enable-link-time-optimization --without-pop --without-xpm --without-jpeg --without-tiff --without-gif --without-png --without-rsvg --without-imagemagick --without-xaw3d --without-compress-install --without-libsystemd CFLAGS='-O3 -march=native'
